...
import { PlayerAttendanceList } from "@/components/admin/player-attendance-list";
    ...
    <div className="mx-auto max-w-4xl">
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-paper-faint">
          Click a player to see everything scheduled for them — events and workouts — and mark present or not
          present. Rates update as you go.
        </p>
      </div>
      ...
      <div className="mb-4 mt-10">
        <p className="eyebrow mb-1">By event</p>
        <h2 className="font-display text-lg font-bold text-paper">Upcoming events</h2>
        <p className="mt-1 text-sm text-paper-faint">
