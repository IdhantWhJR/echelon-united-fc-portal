...
import { SalaryEligibilityToggle } from "@/components/admin/salary-eligibility-toggle";
import { PlayerFinesPanel } from "@/components/admin/player-fines-panel";
  ...
  const [profile, squads] = await Promise.all([
    prisma.playerProfile.findUnique({
      ...
      include: {
        ...
        fines: { orderBy: { issuedAt: "desc" }, include: { issuedBy: { select: { name: true } } } },
      },
    }),
    ...
    <div className="mx-auto max-w-6xl">
      ...
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-3">
        ...
        <div className="space-y-5">
          ...
          <SalaryEligibilityToggle playerId={profile.id} eligible={profile.salaryEligible} />

          <PlayerFinesPanel
            playerId={profile.id}
            fines={profile.fines.map((f) => ({
              id: f.id,
              reason: f.reason,
