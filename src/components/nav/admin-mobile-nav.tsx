...
export function AdminMobileNav() {
  ...
  // Portal target must be attached after mount (no `document` during SSR).
  ...
  return (
    <>
      ...
      {/* Rendered via portal to document.body: the topbar this button lives in is
          `sticky` with its own z-index, which traps `fixed` descendants inside its
          stacking context. Without the portal, the drawer could render behind
          other stacking-context content (e.g. the admin overview panel) even
